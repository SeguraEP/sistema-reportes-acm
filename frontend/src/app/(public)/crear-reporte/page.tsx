//frontend/src/app/(public)/crear-reporte/page.tsx
...
export default function CrearReportePublicoPage() {
...
const onSubmit = async (data: ReporteFormData) => {
  try {
    ...
    setTimeout(() => {
      handleReset();
      router.push(session?.user ? '/dashboard/buscar-reportes' : '/buscar-reportes');
    }, 2000);
